...
;;;;; git-gutter+
   ...
   `(git-gutter+-modified ((t (:foreground ,zenburn-magenta :weight bold :inverse-video t))))
   `(git-gutter+-unchanged ((t (:foreground ,zenburn-fg :weight bold :inverse-video t))))
   `(git-gutter+-separator ((t (:foreground ,zenburn-green :weight bold :inverse-video t))))
   `(git-gutter+-commit-header-face ((t (:foreground ,zenburn-green :weight bold :inverse-video t))))
;;;;; git-rebase
